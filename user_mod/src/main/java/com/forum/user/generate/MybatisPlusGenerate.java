		...
		fastAutoGenerator.packageConfig(builder -> {
			...
			builder.parent("com.forum.article")
				.pathInfo(Collections.singletonMap(OutputFile.xml,
						"/home/lituizi/IdeaProjects/ahut_forum/article_mod/src/main/resources/mapper"));
			...
			builder.entityBuilder()
				...
				.addTableFills(new Column("create_time", FieldFill.INSERT),
						new Column("update_time", FieldFill.INSERT_UPDATE)); // 添加表字段填充，"create_time"字段自动填充为插入时间，"modify_time"字段自动填充为插入修改时间
			builder.controllerBuilder().enableRestStyle().enableFileOverride().enableHyphenStyle();
